# Comprehensive Worksheet Conversion Script
# Converts all worksheets to split-view layout with questions on left and code on right

$worksheetDir = "c:\Users\sedhu\Downloads\Java_Selinium\worksheets"

# Define all worksheets with their questions and code
$allWorksheets = @(
    @{
        file="ws_intro.html"
        ...
        code=@'
// Pseudo-code logic for Automation Test
...
Write-Host "Worksheet Conversion to Split-View Layout" -ForegroundColor Cyan
